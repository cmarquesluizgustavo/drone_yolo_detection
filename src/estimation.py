...
class Camera:
    ...
    # METHOD 1 — pinhole model (pixel height and real height)
    def estimate_distance(self, pixel_height, real_height_m=1.7):
        ...
        return (real_height_m * focal_length_m) / (pixel_height * pixel_size_y_m)

    # METHOD 2 — angle-based (camera_height and alpha and pixel vertical position)
